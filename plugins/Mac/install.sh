...
do
    ...
    install_name_tool -change @executable_path/../Frameworks/MonoEmbedRuntime/osx/libmonobdwgc-2.0.dylib @rpath/libmonobdwgc-2.0.dylib $i
    install_name_tool -add_rpath @executable_path/../Frameworks/MonoBleedingEdge/MonoEmbedRuntime/osx/ $i
    popd
done
